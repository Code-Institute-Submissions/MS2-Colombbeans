...
- Five different sections with fixed navigation menu adapted to the different screen sized and that allow the users to easily browse the site.
...
- Colombbeans farm to cup tasting feature: this would be free coffee samples that can be ordered when initiating bussiness collaborations.
...
3. [Hover.css](https://ianlunn.github.io/Hover/):
    - Hover.css was used grow effect on hover for the desktop navigation items.
